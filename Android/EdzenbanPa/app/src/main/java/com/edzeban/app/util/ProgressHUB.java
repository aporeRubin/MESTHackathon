...
public class ProgressHUB extends Dialog {
    ...
    public ProgressHUB(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static ProgressHUB show(Context context, CharSequence message, boolean indeterminate, boolean cancelable,
